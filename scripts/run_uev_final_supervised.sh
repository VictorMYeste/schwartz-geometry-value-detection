...
#SBATCH --output=/home/hpc/34045staff/output/schwartz-geometry-value-detection/%x-%A_%a.out
#SBATCH --error=/home/hpc/34045staff/output/schwartz-geometry-value-detection/%x-%A_%a.err
...
print_plan() {
  echo "======================================================================"
  echo "UEV final supervised plan"
...
if [ -z "$TASK_ID" ]; then
  ...
  echo "For a local plan only: DRY_RUN=1 bash scripts/run_uev_final_supervised.sh" >&2
  exit 1
fi
...
echo "======================================================================"
echo "UEV final supervised task"
